...
{
    [Info("Building Restriction", "Wulf/lukespragg/P.P", "1.5.10")]
    ...
    public class BuildingRestriction : CovalencePlugin
    {
        ...
        private readonly Dictionary<ulong, HashSet<PlayerNameID>> toolCupboards = new Dictionary<ulong, HashSet<PlayerNameID>>();
